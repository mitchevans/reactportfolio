...
class Burger extends Component {
    render() {
      ...
      >
        ...
        <BackSide
          style={{ border: 'solid', borderWidth: '1px', borderColor: '#fff', backgroundImage: `url( ${Pineapple} )`, backgroundSize: 'cover', position: 'absolute', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
